    ...
    <Container>
      ...
      <Footer>
        <div className="textFooter">
          ...
          <p>Copyright © 2022 SpaceToday Company.</p>
        </div>
        <div className="textFooter">
          <p>Alcântara - MA, 65250-000 * Maranhão * Brasil</p>
          <p>Missão: Base de lançamentos de foguetes</p>
          <p>Lema: Janela Brasileira para o Espaço</p>
        </div>
        <div className="textFooter">
          <p>Contato</p>
          <p>(98) 3311-9000</p>
          <p>spacelabex@travels.com.br</p>
        </div>
      </Footer>
    </Container>
  )
