...
import {GeneralContainer,LeftColDiaDeSorte,RightCol,TitleWrap,Title,LogoLoterias,NumbersWrap,GameTitle,GameNumberDate,Obs,} from "../../constants/StyledGlobal"
...
export default function DiaDeSorte () {
  ...
  return (
    <GeneralContainer>
      <LeftColDiaDeSorte></LeftColDiaDeSorte>
      <TitleWrap>
