...
import {GeneralContainer,LeftColLotoFacil,RightCol,TitleWrap,Title,LogoLoterias,NumbersWrap,GameTitle,GameNumberDate,Obs,} from "../../constants/StyledGlobal"
...
export default function Lotofacil () {
  ...
  return (
    <GeneralContainer>
      <LeftColLotoFacil></LeftColLotoFacil>
      <TitleWrap>
