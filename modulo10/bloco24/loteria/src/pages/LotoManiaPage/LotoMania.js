...
import {GeneralContainer,LeftColLotoMania,RightCol,TitleWrap,Title,LogoLoterias,NumbersWrap,GameTitle,GameNumberDate,Obs,} from "../../constants/StyledGlobal"
...
export default function Lotomania () {
  ...
  return (
    <GeneralContainer>
      <LeftColLotoMania></LeftColLotoMania>
      <TitleWrap>
